...
\item Editar el archivo catalina.properties que se encuentra en la ruta C:\textbackslash EBX\textbackslash TomCat\textbackslash apache.tomcat 9.0.108\textbackslash conf agregando hasta el final del archivo las siguientes líneas de texto: 
\begin{figure}[H]
    \centering
